...
Abordamos el analisis de topicos(LDA) con el objetivo de identificar patrones temáticos en los titulares del BOE. Aplicamos un modelo de Latent Dirichlet Allocation (LDA) sobre los titulares ya procesados lingüisticamente. El análisis se realizó segmentado por quinquenios, con el fin de observar posibles cambios temáticos a lo largo del tiempo.
...
En consecuencia, el análisis de tópicos con LDA no permite extraer información sustantiva sobre los temas tratados en las disposiciones del BOE y no lo usaremos para el resto de nuestro proyecto.
